        ...
        <form className="mx-auto max-w-lg rounded-lg border">
          <div className="flex flex-col gap-4 p-4 md:p-8">
            ...
            <input
              type="submit"
              value="Login"
              className={`block rounded-lg bg-gray-800 px-8 py-3 text-center hover:cursor-pointer text-sm font-semibold text-white outline-none ring-gray-300 transition duration-100 hover:bg-gray-700 focus-visible:ring active-bg-gray-600 md:text-base ${
