...
//   return (
//     <div className="flex bg-whitesmoke h-screen lg:text-md sm:text-base items-center">
      
//       {/* Left side with Calendar */}
//       <div className="flex-shrink-0 flex-glow-0 p-4 h-full bg-whitesmoke" style={{width:'100%'}}>
//         <Calendar showEdit={true} />
//       </div>

//       <div className={`flex-shrink-0 flex-glow-0 p-4 bg-whitesmoke h-full`} style={{ position: 'relative', right: 0, top: 0, bottom: 0 }}>
  ...
  return (
    ...
    <div className="container w-5/6 bg-whitesmoke bg-opacity-30 m-2">
      <div className="flex absolute top-15 right-0 bg-whitesmoke p-4">
        ...
        <label
          htmlFor="fileInput"
          className="block w-full text-sm font-medium text-gray-700 cursor-pointer hover:text-gray-500 rounded-md border border-gray-300 py-2 px-3 dark:border-gray-700 dark:text-gray-400 dark:hover:text-gray-300"
        >
        ...
        <button
          type="button"
          className="inline-flex items-center px-4 py-2 ml-2 text-sm font-semibold rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-offset-0 dark:focus:ring-indigo-700"
        >
          Submit
        </button>
      </div>
